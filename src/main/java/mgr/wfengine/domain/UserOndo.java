...
public class UserOndo {
	...
	public String getNextActList() {
		return nextActList;
	}
	public void setNextActList(String nextActList) {
	...
	public String getFlowVer() {
		return flowVer;
	}
	public void setFlowVer(String flowVer) {
